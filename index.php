        ...
        else 
        {
  		...
  		if ($tag == 'chgpass')
  		{
        	...
        	$salt = $hash["salt"];
         	...
         	$message = "Hello $fname,\n\nYour Password is successfully changed.\n\nRegards,\nFriendly Live Translator Team";
          	$from = "contact@friendlylivetrans.com";
          	$headers = "From:" . $from;
			...
			if ($tag == 'forpass')
			{
        		...
        		$salt = $hash["salt"];
         		...
         		$message = "Hello $fname,\n\nYour Password is successfully changed. \nYour new Password is $randomcode . Login with your new Password and change it in the Settings Panel.\n\nRegards,\nFriendly Live Translator Team";
          		$from = "contact@friendlylivetrans.com";
          		$headers = "From:" . $from;
...
{
    echo "FriendlyLiveTranslator Login API";
}
?>
